(* copied from https://bitbucket.org/khooyp/adapton.ocaml/src/main/Source/AdaptonInternal/TotalOrder.ml*)
...
module Order = struct
  ...
  and t =
    { (* 5 words (not including parent and closure of invalidator) *)
      mutable label : int;
